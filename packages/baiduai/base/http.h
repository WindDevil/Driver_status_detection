...
extern int URLEncode(unsigned char *str, const int strSize, unsigned char *result, const int resultSize);
extern int base64_encode(unsigned char * bytes_to_encode, unsigned char *encode, int bytes_len);
extern int encode(const unsigned char *buf, const long size, unsigned char *base64Char);
